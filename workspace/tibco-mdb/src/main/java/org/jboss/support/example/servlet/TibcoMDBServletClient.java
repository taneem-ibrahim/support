 ...
 */
package org.jboss.support.example.servlet;
 ...
 */
@WebServlet("/TibcoMDBServletClient")
public class TibcoMDBServletClient extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
	private static final int MSG_COUNT = 5;
	
	@Resource(mappedName = "java:/GenericJMS")
    private ConnectionFactory connectionFactory;

    @Resource(mappedName = "java:/CENTENE.CENPAS.CLAIM.INBOUND.PEND.SUBMIT.QV1.JNDI1")
    private Queue queue;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TibcoMDBServletClient() {
        super();
